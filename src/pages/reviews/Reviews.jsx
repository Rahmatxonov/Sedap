      ...
      <div className="bg-gray-100 p-6">
        <div className=" bg-gray-50 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center bg-white shadow rounded-lg px-4 py-2 space-x-2">
              <FiCalendar className="text-blue-500 w-5 h-5" />
              <span className="text-sm text-gray-600">Filter Periode</span>
        ...
        <div className="space-y-6">
          {Array(5)
            ...
            .map((_, index) => (
              <div
                key={index}
                className="bg-white shadow rounded-lg p-6 flex flex-col sm:flex-row sm:items-start space-y-4 sm:space-y-0 sm:space-x-4"
              >
                <img
